...
from api.v1.views.balance_view import UserBalanceViewSet
...
# v1_router.register('course/available',  CourseAvailableViewList, basename='available')
# v1_router.register('course/pay',  CourseViewSet, basename='pay')
...
v1_router.register(r'user-balances', UserBalanceViewSet)
